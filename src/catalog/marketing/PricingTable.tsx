          ...
          <div
            ...
            className={`rounded-xl p-6 flex flex-col justify-between transition-all ${
              tier.highlighted
                ...
                : "border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 shadow-2xs"
            }`}
          >
            {tier.highlighted && (
              <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 text-[10px] uppercase font-bold tracking-widest px-2.5 py-0.5 rounded-full">
                Phổ biến nhất
              </span>
            )}
            ...
            <div className="mt-8 pt-4">
              <button
                type="button"
                className={`w-full py-2 px-3 rounded-lg text-xs font-semibold shadow transition-all ${
                  tier.highlighted
                    ? "bg-zinc-900 text-white hover:bg-zinc-800 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-200"
                    : "border border-zinc-300 dark:border-zinc-700 text-zinc-800 dark:text-zinc-200 hover:bg-zinc-50 dark:hover:bg-zinc-900"
                }`}
              >
                {tier.buttonText}
              </button>
